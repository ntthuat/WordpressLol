...
$cminds_plugin_config = array(
    ...
    'plugin-upgrade-text'              => '    <div style="display:block">
        <p>Use the most trusted WordPress knowledge base plugin to improve your site organization, SEO, and user experience all in one! Quickly build a dictionary, encyclopedia, wiki, online library, or glossary of terms with popup info boxes internally linking to dedicated term and index pages.</p>
        <ol>
           <li>Unlimited glossary terms</li>
            <li>Optimized for speed</li>
            <li>Support all post types</li>
            <li>Customize Tooltip look and feel</li> 
            <li>Share your glossary with other sites</li>   
            <li>Synonyms, singular & plural </li>
            <li>Improve your site SEO </li>
            <li>Enhanced mobile support </li>
             <li>Connect to external API  </li>
             <li>Expert helpdesk support </li>
        </ol>
    </div>',
    'plugin-upgrade-video-height'      => 240,
    'plugin-upgrade-videos'            => array(
        array( 'title' => 'Glossary Introduction', 'video_id' => '109103390' ),
    ),
	...
	'plugin-compare-table'			 => '
            ...
            <div class="pricing-table" id="pricing-table"><h2 style="padding-left:10px;">Upgrade The Tooltip Glossary Plugin:</h2>
              ...
              <ul>
                     <li class="heading">Pro+<a href="https://www.cminds.com/store/tooltipglossary/af/4806?utm_source=WordPress&utm_medium=Glossary" style="float:right;font-size:11px;color:white;" target="_blank">More</a></li>
                    <li class="price">$45.00<br /> <span style="font-size:14px;">(For one Year / Site)<br />Additional pricing options available <a href="https://www.cminds.com/store/tooltipglossary/af/4806?utm_source=WordPress&utm_medium=Glossary" target="_blank"> >>> </a></span> <br /></li>
                    ...
                    <li class="price">$59.00<br /> <span style="font-size:14px;">(For one Year / Site)<br />Additional pricing options available <a href="https://www.cminds.com/store/tooltipglossary/af/4806?utm_source=WordPress&utm_medium=Glossary" target="_blank"> >>> </a></span> <br /></li>
