        ...
        public function displayPage() {
            ...
            <div class="wrap">
                ...
                <h2>
                    ...
                    <?php echo $this->getOption( 'plugin-name' ) ?>&nbsp; <a href="<?php echo esc_url( get_admin_url( '', 'admin.php?page=cmtt_pro' )); ?>" class="button button-primary" title="Click to Buy PRO">Upgrade to Pro</a>
                </h2>
                <?php
                echo $this->showNav();
...
//						'30' => 'Upgrade Tutorial',
        ...
        public function showUpgrade( $atts = array() ) {
            ...
            $showUpgrade = $currentPlugin->getOption( 'plugin-show-upgrade' );
            if ( $showUpgrade ) :
                ob_start();
                ?><style type="text/css">
                            ...
                            if ( !empty( $upgradeText ) ) :
                                ...
                                <div class="upgrade_text">
                                    <div class="upgrade_header">
                                        Why you Should Upgrade to the Premium Edition
                                    </div>
                                        ...
                                        <?php foreach ( $videos as $key => $video ) : ?>
                                            <div class="upgrade_video <?php echo!$key ? 'active' : ''; ?>">
                                                ...
                                                <div class="upgrade_video_content">
                                                    <iframe src="https://player.vimeo.com/video/<?php echo $video[ 'video_id' ]; ?>?title=0&byline=0&portrait=0" width="463" height="255" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                                    <a href="https://player.vimeo.com/video/<?php echo $video[ 'video_id' ]; ?>?title=0&byline=0&portrait=0" target="_blank">Open in a new window</a>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                    <div class="upgrade_videos_after">
                                        <a href="<?php echo esc_url( get_admin_url( '', 'admin.php?page=cmtt_pro' )); ?>" class="button button-primary" style="background-color:green" title="Click to Buy PRO">Show me Upgrade Options</a> 
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="clear clearfix cmclearfix"></div>
                        <a class="cminds-ads-hide-button" href="<?php echo add_query_arg( array( 'cminds_upgrade_hide' => 1 ), remove_query_arg( 'cminds_upgrade_show' ) ); ?>">Hide Upgrade Box</a>
                    </div>
                    <div class="clear clearfix cmclearfix"></div>
                <?php else : ?>
                    <div class="cminds_upgrade_wrapper">
        ...
        public function showAds( $atts = array() ) {
            ...
            <?php if ( !$adsHidden ) : ?>
                ...
                <?php if ( !$atts[ 'flat' ] ) : ?>
                    ...
                    <div class="cminds_ads_wrapper">
                        <div>
                            <a class="cminds-ads-show-button cminds_link" style="background-color: green;color:white;" href="<?php echo add_query_arg( array( 'cminds_ad_show' => 1 ), remove_query_arg( 'cminds_ad_hide' ) ); ?>">Show Discounts</a>
                        </div>
                    </div>
                    ...
                    <div id="cminds_offers_wrapper" class="cminds_ads_wrapper hidden">
                        ...
                        <div class="cminds_links">
                            <a href="<?php echo $this->getStoreUrl(); ?>" class="cminds_link orange" target="_blank">View all CreativeMinds Plugins</a>
                            <a href="<?php echo $this->getStoreUrl( array( 'category' => 'Bundle' ) ); ?>" class="cminds_link blue" target="_blank">View Bundles</a>
                            <a href="<?php echo $this->getStoreUrl( array( 'category' => 'Add-On' ) ); ?>" class="cminds_link blue" target="_blank">View Add-Ons</a>
                            <a href="<?php echo $this->getStoreUrl( array( 'category' => 'Service' ) ); ?>" class="cminds_link blue" target="_blank">View Services</a>
                        </div>
                        ...
                        <div>
                            ...
                            <?php else : ?>
                                <a class="cminds-ads-refresh-button" href="<?php echo add_query_arg( array( 'cminds_ad_refresh' => 1 ) ); ?>">You haven't refreshed the discounts for <?php echo $days_since_last_refresh . ' ' . _n( 'day', 'days', $days_since_last_refresh ); ?>. <strong>Refresh now!</strong></a>
                            <?php endif; ?>
                            &nbsp;&nbsp;|&nbsp;&nbsp;<a class="cminds-ads-hide-button" href="<?php echo add_query_arg( array( 'cminds_ad_hide' => 1 ), remove_query_arg( 'cminds_ad_show' ) ); ?>">Hide Discounts</a>
                        </div>
            ...
            <?php else: ?>
                <div class="cminds_ads_wrapper">
                    <div>
                        <a class="cminds-ads-show-button cminds_link" href="<?php echo add_query_arg( array( 'cminds_ad_show' => 1 ), remove_query_arg( 'cminds_ad_hide' ) ); ?>">Show CreativeMinds Discounts</a>
                    </div>
                </div>
                <div class="cminds_ads_wrapper">
                    <div>
            ...
            if ( $this->getOption( 'plugin-show-upgrade-first' ) ) {
